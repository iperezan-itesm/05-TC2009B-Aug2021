...
; Blue  LED is connected to PORTD13
...
__main
    ...
    STR r4,[r1,r2] ; 0x40048038 = 0x00000C00

    ; 3) Configure PORTB and PORTD as GPIOs
    ;    PORTB18 as GPIO
    ...
    LDR r2,=PCR_BIT_OFFSET_13
    LDR r3,=PORTx_PCRn_MUX_GPIO_MASK
    STR r3,[r1,r2]

    ; 4) Configure PORTB18, PORTB19 and PORTD13 as outputs
    ...
    ;LDR r1,=PORTB_GPIOx_BASE
    ;LDR r2,=GPIOx_PDOR_OFFSET
    ;LDR r3,=SET_BIT_INDEX_19
    ;STR r3,[r1,r2]

    ;LDR r1,=PORTD_GPIOx_BASE
    ;LDR r2,=GPIOx_PDOR_OFFSET
    ;LDR r3,=CLEAR_BIT_INDEX_13
    ;STR r3,[r1,r2]
